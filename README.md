...
the owner himself. This kind of hat is subjected to the [Hat Inheritance Rules](#hat-inheritance-rules)
...
owner, hence the [Hat Inheritance Rules](#hat-inheritance-rules) do not apply to this address.
