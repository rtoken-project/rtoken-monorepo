...
contract('RToken', accounts => {
  ...
  //   await web3tx(
  //     rToken.changeHat,
  //     'rToken changeHat for customer3 with selfhat'
  //   )(SELF_HAT_ID, {
  //     from: customer3
  //   });
  //   await web3tx(
  //     rToken.transfer,
  //     'rToken.transfer all from customer1 to customer3'
  //   )(customer3, toWad(20), {
  //     from: customer1
  //   });
  //   await expectAccount(customer1, {
  ...
  //   await expectRevert(
  //     web3tx(rTokenLogic.initialize, 'rTokenLogic.initialize second time')(
  //       compoundAS.address,
  //       'RToken Test',
  //       'RTOKEN',
  //       18,
  ...
  //
  //   await expectRevert(
  //     web3tx(rTokenLogic.updateCode, 'rTokenLogic.updateCode from non-owner')(
  //       compoundAS.address,
  //       {
  //         from: customer1
  //       }
  ...
  //   )(compoundAS.address, 'RToken Test', 'RTOKEN', 18, {
  //     from: admin
  //   });
  //
  //   // Test new logic contract
  //   await expectRevert(
  //     web3tx(newRTokenLogic.initialize, 'rTokenLogic.initialize second time')(
  //       compoundAS.address,
  //       'RToken Test',
  //       'RTOKEN',
  //       18,
  ...
  //
  //   await expectRevert(
  //     web3tx(rToken.changeHatFor, 'rToken.changeHatFor by customer1')(
  //       cToken.address,
  //       1,
  //       {
  //         from: customer1
  ...
  //   for (let i = 1; i <= 50; ++i) {
  //     sombrero.addresses.push(
  //       `0x${i}000000000000000000000000000000000000000`.substr(0, 42)
  //     );
  ...
  //   await web3tx(
  //     rToken.mintWithNewHat,
  //     'rToken.mint 100 to customer1 with a sombreror',
  //     {
  //       inLogs: [
  //         {
  //           name: 'Transfer'
  ...
  //   tx = await web3tx(
  //     rToken.transfer,
  //     'rToken.transfer 10 customer1 -> customer2 again'
  //   )(customer2, toWad(10), {
  //     from: customer1
  //   });
  //   console.debug('Same hat transfer tx cost', tx.receipt.gasUsed);
  //   assert.isTrue(
  //     tx.receipt.gasUsed < 300000,
  //     'Same hat optimization was not applied'
  //   );
  //
  ...
  //   sombrero.proportions.push(1);
  //   await expectRevert(
  //     web3tx(rToken.createHat, 'rToken.createHat by bigger sombrero')(
  //       sombrero.addresses,
  //       sombrero.proportions,
  //       {
  //         from: admin
  //       }
  //     ),
  ...
  //   await web3tx(
  //     rToken.mintWithNewHat,
  //     'rToken.mint 100 to customer3 with a smaller sombrero',
  //     {
  //       inLogs: [
  //         {
  //           name: 'Transfer'
  ...
  //   await expectRevert(
  //     rToken.createHat([ZERO_ADDRESS], [1], true, {
  //       from: customer1
  //     }),
  ...
  //   {
  //     // from 0.1 to 0.01
  //     const result = await createCompoundAllocationStrategy(toWad(0.01));
  ...
  //   }
  //   await web3tx(
  //     compoundAS2.transferOwnership,
  //     'compoundAS2.transferOwnership'
  //   )(rToken.address);
  //   await web3tx(
  //     compoundAS3.transferOwnership,
  //     'compoundAS3.transferOwnership'
  //   )(rToken.address);
  //
  //   await web3tx(token.approve, 'token.approve 100 by customer1')(
  ...
  //   assert.equal(wad4human(await token.balanceOf.call(customer1)), '900.00000');
  //   assert.equal(
  //     wad4human(await token.balanceOf.call(cToken.address)),
  //     '100.00000'
  //   );
  //   assert.equal(
  //     wad4human(await cToken.balanceOf.call(compoundAS.address)),
  //     '1000.00000'
  //   );
  //   assert.equal(
  //     wad4human(await rToken.balanceOf.call(customer1)),
  ...
  //   );
  //   assert.equal(
  //     wad4human(await rToken.receivedSavingsOf.call(customer1)),
  //     '100.00000'
  //   );
  //
  //   await web3tx(
  //     rToken.changeAllocationStrategy,
  ...
  //   );
  //   assert.equal(
  //     wad4human(await token.balanceOf.call(cToken2.address)),
  //     '100.00000'
  //   );
  //   assert.equal(
  //     wad4human(await cToken2.balanceOf.call(compoundAS2.address)),
  //     '10000.00000'
  //   );
  //   assert.equal(wad4human(await token.balanceOf.call(customer1)), '900.00000');
  //   assert.equal(
  ...
  //   );
  //   assert.equal(
  //     wad4human(await token.balanceOf.call(cToken3.address)),
  //     '100.00000'
  //   );
  //   assert.equal(
  //     wad4human(await cToken3.balanceOf.call(compoundAS3.address)),
  //     '10.00000'
  //   );
  //   assert.equal(wad4human(await token.balanceOf.call(customer1)), '900.00000');
  //   assert.equal(
  ...
  //   );
  //
  //   await web3tx(rToken.redeem, 'rToken.redeem 10 to customer1')(toWad(100), {
  //     from: customer1
  //   });
  //   assert.equal(
  //     wad4human(await token.balanceOf.call(cToken3.address)),
