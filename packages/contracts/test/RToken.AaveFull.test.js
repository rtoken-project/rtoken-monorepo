...
contract("RToken with Aave Strategy", accounts => {
    ...
    it("#3 normal operations with hat", async () => {
        ...
        console.log(await rdai.getHatByAddress.call(customer1));
        ...
        asBalanceNext = await adai.balanceOf(aaveAS.address);
        earning = asBalanceNext.sub(new BN(toWad(100)));
        ...
        await expectAccount(admin, {
            ...
            cumulativeInterest: "0.00000",
            receivedLoan: "90.00000",
            receivedSavings:  wad4human(earning.muln(90).divn(100).add(new BN(toWad(90)))),
            interestPayable: wad4human(earning.muln(90).divn(100)),
        });
        await expectAccount(customer2, {
            tokenBalance: "0.00000",
            cumulativeInterest: "0.00000",
            receivedLoan: "10.00000",
            receivedSavings: wad4human(earning.muln(10).divn(100).add(new BN(toWad(10)))),
            interestPayable: wad4human(earning.muln(10).divn(100)),
        });
        ...
        //     admin, { from : admin });
        // assert.equal(wad4human(await rdai.totalSupply.call()), "90.00093");
        // await expectAccount(customer1, {
        //     tokenBalance: "80.00000",
        //     cumulativeInterest: "0.00000",
        //     receivedLoan: "0.00000",
        ...
        // await web3tx(rdai.transfer, "rdai.transfer 10 customer3 -> customer1")(
        ...
        // await web3tx(rdai.transfer, "rdai.transfer 10 customer1 -> customer2")(
        ...
        // await web3tx(rdai.transferAll, "rdai.transferAll customer2 -> customer1")(
